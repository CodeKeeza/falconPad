...
contract FalconPad is ERC20, Ownable, SafeToken, LockToken{
     ...
     uint256 public maxWalletLimit = 2_000_000 * 10**18; // 2% supply
     ...
     constructor() ERC20("FalconPad", "FLC") {
         ...
         //Define Router
         IRouter _router = IRouter(0x989dBb40f0B8a431e9D79dfd28fdC3df3717D9c0); // CRONASWAP ROUTER 0xcd7d16fB918511BF7269eC4f48d61D79Fb26f918 // PCS ROUTER 0x10ED43C718714eb63d5aA57B78B54704E256024E
